				...
				<div class="panelContent">
					<div class="featuresShowcase right">
						...
						<div class="featureContent">
							...
							<p>WISE提供簡單的使用者介面、認知提示、嵌入式回應筆記與評量、線上討論，而且還有提供活動使用的軟體工具像畫板、概念地圖、表格與圖示。WISE亦可使用多樣化的網路科技建立互動式的模擬和模型。WISE課程透過合作反思活動與教師的回饋促進學生自我檢視。</p>
						</div>
					...
					<div class="featuresShowcase right">
						...
						<div class="featureContent">
							...
							<ul>
								...
								<li><span style="font-weight:bold;">評論與回饋：</span><br>學生透過風格性、目的性和證據來源提出評論以評估不同的論點，以這些評論為基礎，他們寫下了給同儕的重要回應。</li>
					...
					<div class="featuresShowcase left">
						...
						<div class="featureContent">
							...
							<ul>
								<li><span style="font-weight:bold;">想法管理者：</span><br>就內容、來源以及主張的連結而言，圖形化組織工具引導了證據的評估。Idea Basket提供一個持續性的空間讓學生蒐集和整理多媒體資料。Explanation Builder使用 Idea Basket的證據，提供一個組織化的空間，對辯論論述提供了鷹架。</li>
								<li><span style="font-weight:bold;">繪圖 & 影格動畫：</span><br>學生可以畫下並擷取快照來建立動畫，並且可以重新播放他們的影格動畫。這樣可以引導學生將他們的論點轉化為不同的表現形式。</li>
								<li><span style="font-weight:bold;">我的系統：</span><br>圖表工具可以視覺化事件的順序並引導學生寫下口語的描述。轉化不同的表現方式幫助學生辨別描述性的抽象架構以及關鍵內容細節。</li>
							</ul>
						</div>
						<div style="clear:both;"></div>
					</div>
					<div class="featuresShowcase right">
						...
						<div class="featureContent">
							...
							<ul>
								<li><span style="font-weight:bold;">探索 & 角色扮演：</span><br>WISE課程探究個人有意義的驅動問題。學生像科學家一般去探究一些現象，幫助學生覺得科學是可接近的，這樣可以提高他們去完成探究科學的動機。</li>
								<li><span style="font-weight:bold;">同儕互評 & 回饋：</span><br>學生暱名而被指定去分析與評論同儕。練習從過程中產生評論與回饋可以幫助學生發展重要的評估能力有如合作性的知識建構。</li>
